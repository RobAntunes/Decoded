...
export default function StylishCarousel() {
  ...
  return (
    <div className="w-full h-full py-20 relative">
      <div>
        <p className="relative max-w-7xl pl-4 mx-auto font-semibold text-sm text-blue-600">
          From anywhere to everywhere
        </p>
        <h2 className="relative z-50 max-w-7xl pl-4 mx-auto text-xl md:text-6xl font-bold text-neutral-800 dark:text-neutral-200 font-sans">
          Global{" "}
