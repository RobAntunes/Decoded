            ...
            <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
                <div className="relative isolate overflow-hidden bg-gray-100 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                    ...
                    <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                        <h2 className="text-5xl font-semibold tracking-tight text-balance text-neutral-900">
                            {"Unleash your business's potential."}
                            <br />
                            <br />{" "}
                            <span className="text-3xl text-blue-500">
                                Start using Decoded today.
                            </span>
                        </h2>
                        <p className="mt-6 text-lg/8 text-pretty text-neutral-600">
